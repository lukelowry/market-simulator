...
{:else}
	...
	<div class="flex justify-end mb-2">
		<button class="flex items-center gap-1.5 text-xs text-text-muted hover:text-maroon transition-colors duration-100 py-1.5 px-2 -mr-2 rounded-sm" onclick={() => fetchMarkets()} aria-label="Refresh market list">
